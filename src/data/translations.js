...
const translations = {
    ...
    ar: {
        ...
        seo: {
            ...
            chatbot: {
                title: "المساعد الذكي - إسلمو إيدعيش",
                description: "تفاعل مع المساعد الذكي الخاص بإسلمو إيدعيش. اسأل عن تطوير الويب، الذكاء الاصطناعي، التعلم الآلي، التعلم العميق والمزيد.",
                keywords: "مساعد الذكاء الاصطناعي, شات بوت, إسلمو إيدعيش, تطوير الويب, الذكاء الاصطناعي, التعلم الآلي, التعلم العميق, بورتفوليو,المساعد الذكي"
            }
        },
